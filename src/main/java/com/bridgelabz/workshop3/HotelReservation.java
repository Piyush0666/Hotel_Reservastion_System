...
public class HotelReservation implements HotelReservationIF {
    ...
    public void addHotel(String hotelName, int rating, double weekdayRate, double weekendRate,double weekdayCustomerRate,double weekendCustomerRate) {
        hotel = new Hotel();
        ...
        try {
            if(customerType.length() == 0) {
                ...
                for (Hotel hotel : hotelList) {
                    if(customerType.equals("reward")) {
                        rateForHotel = (int) ((weekdaysNumber * hotel.getWeekdayRewardCustomerRate())+ (weekends * hotel.getWeekendRewardCustomerRate()));
                    }else {
                        rateForHotel = (int) ((weekdaysNumber * hotel.getWeekDayRate()) + (weekends * hotel.getWeekendRate()));
                    }
